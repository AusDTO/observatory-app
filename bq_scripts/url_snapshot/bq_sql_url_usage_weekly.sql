...
DROP TABLE IF EXISTS t_urlsnap_prototype_weekly_1;
DROP TABLE IF EXISTS t_urlsnap_prototype_weekly_2;
DROP TABLE IF EXISTS t_urlsnap_prototype_weekly_3;
DROP TABLE IF EXISTS t_urlsnap_prototype_weekly_4;
End;
...
-- Storing Page URLs weekly aggregated dimensions in BigQuery
  create or replace table dta_customers.ua_61222473_13_urlpage_usage_weekly
      OPTIONS (
            description = "Weekly url page usage dimensions on daily schedule",
            expiration_timestamp = TIMESTAMP_ADD(current_timestamp, INTERVAL 24 HOUR)
  )
...
-- Storing Page URLs weekly aggregated dimensions in BigQuery
  create or replace table dta_customers.ua_61222473_33_urlpage_usage_weekly
      OPTIONS (
            description = "Weekly url page usage dimensions on daily schedule",
            expiration_timestamp = TIMESTAMP_ADD(current_timestamp, INTERVAL 24 HOUR)
  )
