...
# Type Daily Top Pages
    ...
    def prepare_outtype1(data_tp, data_tg):
        ...
        for datum in data_tp:
            ...
            top10p.append({"pageUrl": pageurl_tp, "pageTitle": pagetitle_tp,
        ...
        for datum in data_tg:
            ...
            top10g.append({"pageUrl": pageurl_tg, "pageTitle": pagetitle_tg,
                           "pageViews": pageviews_tg, "rank": top_rank_tg, "percentage": growth_percent})

        property_id, hostname, users, newUsers, returningUsers, pageviews, time_on_page, bounce_rate, sessions, aveSession, pagesPerSession, aveSessionDuration, pageviews_tg, pagetitle_tg, pageurl_tg, growth_percent, top_rank_tg, week_start, week_end = datum
        output.append({"dateEnding": week_end, "users": users, "pageViews": pageviews, "timeOnPage": time_on_page, "bounceRate": bounce_rate, "sessions": sessions, "aveSessionsPerUser": aveSession,
                       "pagesPerSession": pagesPerSession, "aveSessionDuration": aveSessionDuration, "newUsers": newUsers, "returningUsers": returningUsers, "topTenGrowth": top10g, "topTenPageViews": top10p})
...
# Daily data output transform function
    ...
    def prepare_outtype2(data_, data_tp1, data_tg1, data_tp2, data_tg2, data_tp3, data_tg3, data_tp4, data_tg4, data_tp5, data_tg5, data_tp6, data_tg6, data_tp7, data_tg7):
        ...
        for datum_p1 in data_tp1:
            ...
            top10p1.append({"pageUrl": pageurl_tp, "pageTitle": pagetitle_tp,
                            "pageViews": pageviews_tp, "rank": top_rank_tp, "percentage": trend_percent})
        ...
        for datum_g1 in data_tg1:
            ...
            top10g1.append({"pageUrl": pageurl_tg, "pageTitle": pagetitle_tg,
                            "pageViews": pageviews_tg, "rank": top_rank_tg, "percentage": growth_percent})
        ...
        for datum_p2 in data_tp2:
            ...
            top10p2.append({"pageUrl": pageurl_tp, "pageTitle": pagetitle_tp,
                            "pageViews": pageviews_tp, "rank": top_rank_tp, "percentage": trend_percent})
        ...
        for datum_g2 in data_tg2:
            ...
            top10g2.append({"pageUrl": pageurl_tg, "pageTitle": pagetitle_tg,
                            "pageViews": pageviews_tg, "rank": top_rank_tg, "percentage": growth_percent})
        ...
        for datum_p3 in data_tp3:
            ...
            top10p3.append({"pageUrl": pageurl_tp, "pageTitle": pagetitle_tp,
                            "pageViews": pageviews_tp, "rank": top_rank_tp, "percentage": trend_percent})
        ...
        for datum_g3 in data_tg3:
            ...
            top10g3.append({"pageUrl": pageurl_tg, "pageTitle": pagetitle_tg,
                            "pageViews": pageviews_tg, "rank": top_rank_tg, "percentage": growth_percent})
        ...
        for datum_p4 in data_tp4:
            ...
            top10p4.append({"pageUrl": pageurl_tp, "pageTitle": pagetitle_tp,
                            "pageViews": pageviews_tp, "rank": top_rank_tp, "percentage": trend_percent})
        ...
        for datum_g4 in data_tg4:
            ...
            top10g4.append({"pageUrl": pageurl_tg, "pageTitle": pagetitle_tg,
                            "pageViews": pageviews_tg, "rank": top_rank_tg, "percentage": growth_percent})
        ...
        for datum_p5 in data_tp5:
            ...
            top10p5.append({"pageUrl": pageurl_tp, "pageTitle": pagetitle_tp,
                            "pageViews": pageviews_tp, "rank": top_rank_tp, "percentage": trend_percent})
        ...
        for datum_g5 in data_tg5:
            ...
            top10g5.append({"pageUrl": pageurl_tg, "pageTitle": pagetitle_tg,
                            "pageViews": pageviews_tg, "rank": top_rank_tg, "percentage": growth_percent})
        ...
        for datum_p6 in data_tp6:
            ...
            top10p6.append({"pageUrl": pageurl_tp, "pageTitle": pagetitle_tp,
                            "pageViews": pageviews_tp, "rank": top_rank_tp, "percentage": trend_percent})
...
bigquery_data_type2 >> [bigquery_fetch_type2_1,
                        ...
                        bigquery_fetch_type2_4_tgw_day5,
                        bigquery_fetch_type2_4_tgw_day6,
                        bigquery_fetch_type2_4_tgw_day7,
                        bigquery_fetch_type2_5,
                        bigquery_fetch_type2_5_tpgs_day1,
                        bigquery_fetch_type2_5_tpgs_day2,
                        bigquery_fetch_type2_5_tpgs_day3,
                        bigquery_fetch_type2_5_tpgs_day4,
                        bigquery_fetch_type2_5_tpgs_day5,
                        bigquery_fetch_type2_5_tpgs_day6,
                        bigquery_fetch_type2_5_tpgs_day7,
                        bigquery_fetch_type2_5_tgw_day1,
                        bigquery_fetch_type2_5_tgw_day2,
                        bigquery_fetch_type2_5_tgw_day3,
                        bigquery_fetch_type2_5_tgw_day4,
                        bigquery_fetch_type2_5_tgw_day5,
                        bigquery_fetch_type2_5_tgw_day6,
                        bigquery_fetch_type2_5_tgw_day7] >> update_type2_to_rds

bigquery_data_type3 >> [bigquery_fetch_type3_1,
                        #  bigquery_fetch_type3_2
                        bigquery_fetch_type3_3,
                        bigquery_fetch_type3_4,
                        bigquery_fetch_type3_5] >> update_type3_to_rds
