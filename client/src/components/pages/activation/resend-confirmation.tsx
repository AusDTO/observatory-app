...
export const ResendConfirmation: React.FC<Props> = ({ history, location }) => {
  ...
  return (
    <DefaultLayout>
      <div className="container-fluid au-body">
        <p>
          It seems the link is broken or expired. Enter your email below and we
          will send you a new confirmation link
        </p>
        <Formik
